...
Функция НаборИконок() Экспорт 
	
	Возврат ЗначениеИзСтрокиВнутр(ПолучитьМакет("НаборИконок").ПолучитьТекст());
...
Процедура СоздатьКнопки(Форма, Элемент, КомандыЭлемента) Экспорт 
