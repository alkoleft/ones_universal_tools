...
Функция ПоместитьЗапросСКД(СхемаКомпоновкиДанных, Настройки, Знач Адрес = Неопределено) Экспорт 
	...
	Возврат ПоместитьЗапрос(ПолучитьЗапросСКД(СхемаКомпоновкиДанных, Настройки), Адрес);
	
КонецФункции

Функция ПоместитьЗапросДС(Элемент, Знач Адрес = Неопределено) Экспорт 
	
	Схема = Элемент.ПолучитьИсполняемуюСхемуКомпоновкиДанных();
	Настройки = Элемент.ПолучитьИсполняемыеНастройкиКомпоновкиДанных();
	
	Возврат ПоместитьЗапросСКД(Схема, Настройки, Адрес);
	
КонецФункции

Функция ПолучитьЗапросСКД(СхемаКомпоновкиДанных, Знач Настройки)
	
	Настройки = ПолучитьНастройкиСКД(Настройки);
...
Функция ПолучитьДанныеЗапроса(Запрос) 
	...
	ДанныеЗапроса.Текст = Запрос.Текст;
	ДанныеЗапроса.Параметры = ЗначениеИзСтрокиВнутр(ЗначениеВСтрокуВнутр(Запрос.Параметры));
...
Функция ПолучитьНастройкиСКД(Компановщик)
