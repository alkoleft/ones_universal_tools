...
Функция ПараметрыПубликации()
	...
	Параметры.Вставить("version", "v1.0.4");
...
&НаСервереБезКонтекста
Функция ВыполнитьЗапросСкриптНаСервере(Знач Текст, Знач ПараметрыВыполнения, Знач ЭтоЗапрос, Знач АдресРезультата)
...
&НаСервереБезКонтекста
Функция ВыполнитьЗапросНаСервере(Знач Текст, Знач ПараметрыВыполнения)
...
&НаКлиенте
Функция ВыполнитьСкриптНаКлиенте(Знач Текст, Знач Параметры)
...
Процедура ПослеВыполнения()
	...
	Описание.Добавить(ФорматВремяВыполнения(РезультатВыполнения.ОбщееВремя), "Время общее");
