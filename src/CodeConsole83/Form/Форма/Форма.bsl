...
Функция ОписаниеДопустимыеТипы()
	...
	Примитивы = Новый ОписаниеТипов("УникальныйИдентификатор, ВидДвиженияНакопления, Булево, ВидДвиженияБухгалтерии, ВидСчета, Строка, Дата, Null, Число");
...
Процедура ВыбраннаяНастройка_ПараметрыПриАктивизацииСтроки(Элемент)
	...
	Иначе
		...
		Элементы.ВыбраннаяНастройка_ПараметрыЗначение.ОграничениеТипа = ?(ЗначениеЗаполнено(Элемент.ТекущиеДанные.ТипПараметра), Элемент.ТекущиеДанные.ТипПараметра, ДопустимыеТипы);
