...
Процедура ЗаполнитьНаборТестов(НаборТестов) Экспорт
	...
	НаборТестов.Добавить("ТестДолжен_ПроверитьОткрытиеФормыОбработки", , "Проверка открытие формы");
	НаборТестов.Добавить("ТестДолжен_Проверить_Настройки_ДобавитьЗапрос", , "Проверка добавить запрос");
	НаборТестов.Добавить("ТестДолжен_Проверить_УстановкуТекстаЗапроса", , "Проверка установить текст запроса ""ВЫБРАТЬ &Значение""")
...
&НаКлиенте
Процедура ТестДолжен_Проверить_УстановкуТекстаЗапроса(ТекстЗапроса = "ВЫБРАТЬ 1 Значение") Экспорт 
	Сообщить("Шаг 1");	
